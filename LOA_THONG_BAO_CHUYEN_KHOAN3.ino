...
const char* ssid = "Lupasta_mesh";
const char* password = "wifidanghong";
String api_token = "ZHMH5ZMQRDIHCIAODNRA9EYTE35IJFPUXALC6QT08NLG2KBIYPNV4BZR7H2ERWKJ"; // Thay thế bằng API token của bạn
String accountNumber = "VQRQABXZV6936";//Thay thế bằng account của bạn
...
// Thông tin tài khoản
String accountName = "LE THANH AN";  // Tên tài khoản
